...
public class VilaoGoomba extends Personagem {
	
	private int limiteEsquerda;
	private int limiteDireita;	
	private int vida;

	public VilaoGoomba(int x, int y, int id, int limiteEsquerda, int limiteDireita) {
		super();
		vida = 1;
		movimento = 1;
	...
	public void draw(Graphics g) {
		if (id != 0) {
			g.drawImage(Imagem.getInstance().getImagens()[8], retangulo.x - (int) camera.getxOffset(),
