...
public class VilaoFlappy extends Personagem {
	...
	public VilaoFlappy(int x, int y, int id, int limiteEsquerda, int limiteDireita) {
		super();
		velPulo = 2;
	...
	public void draw(Graphics g) {
		if (id != 0) {
			g.drawImage(Imagem.getInstance().getImagens()[9], retangulo.x - (int) camera.getxOffset(),
